...
//  def processPartitionPerRow(iterator: Iterator[Row])(implicit kieBase: KieBase): Iterator[Row] = {
//    println("\n\n=== SESSION PER ROW ==============")
//    try {
//      iterator.map { row =>
//        val name = row.getAs[String]("name")
...
//          //            println(person)
//          Row.fromSeq(Seq(person.getName, person.getAge))
//        } catch {
//          case e: Exception =>
//            println(e.getMessage)
...
//    def setVals(name: String, age: Int ): Unit = {
//        this.age = age
//        this.name = name
//    }
//  }
